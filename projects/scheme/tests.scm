...
(define b (mu (x) (* 10 x)))
(multiply (a 4 2 3) (b 1))
; expect 50

(define a (a 6 6 1))
(and (> a 2) #t (/ 0 0) #t #yoloswag)
; expect False

(/ (and #t (= 1 1) (list 1 2 3) 7 8) 4)
; expect 2

(define krispy-kreme 4)
(define king-pin 16)
(or (> krispy-kreme king-pin) "i like donuts :)")
; expect "i like donuts :)"

(or (< (sign 5) 0) (ordered? (list 1 4 5 2)) (and 9 (> 3 4) #t) "hello world" #f (f x) (= 4 (multiply 3 2)))
; expect "hello world"
